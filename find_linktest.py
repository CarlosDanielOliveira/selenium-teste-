...
#Usado com HTML <a>login</a>
link_home_navegacao = driver.find_element(By.LINK_TEXT, 'Home')  #Poderia buscarr por parte parcial do texto (By.PARTIAL_LINK_TEXT, 'Ho')

if link_home_navegacao is not None:
    print('Foi encontrado - link HOME')
